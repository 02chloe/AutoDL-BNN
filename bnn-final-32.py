...
id = 189356
task = openml.tasks.get_task(task_id=189356)
...
# score = 'bnn-53'
# fit_t = 'bnn-53'
with open('/user/work/aj20377/workshop/bnn-189356-score.txt','a') as file: 
    file.write(str(score))
    file.write('\n')

with open('/user/work/aj20377/workshop/bnn-189356-time.txt','a') as file:    
